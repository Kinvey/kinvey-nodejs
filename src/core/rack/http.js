...
var Http = function (_Middleware) {
  _inherits(Http, _Middleware);

  function Http() {
    _classCallCheck(this, Http);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(Http).call(this, 'Kinvey Http Middleware'));
  }

  _createClass(Http, [{
    key: 'handle',
    value: function handle(request) {
      return _get(Object.getPrototypeOf(Http.prototype), 'handle', this).call(this, request).then(function () {
        var options = {
          url: request.url,
